...
class Relatorios(Event):
    ...
    def geraRel(self):
        self.pedidosRelatorio = canvas.Canvas(
            self.input_codProduto.get()+"_pedido.pdf")
        ...
        self.pedidosRelatorio.drawString(
            150, 45, 'Rua Governador Dix Sept Rosado, Campo Grande, Recife - PE - CEP 52031010')
        self.pedidosRelatorio.drawString(
            230, 60, 'O açai mais gostoso da região')
        ...
        self.pedidosRelatorio.drawImage(
            "bow.png", 50, 60, width=60, height=63, mask=[255, 255, 255])
